<script setup>
import {DownloadObject} from "@/api/objects.js";
...
<template>
  <div class="side-bar" v-if="showComponent && props.data!==null">
    <el-button type="text" @click="toggleComponent">Toggle Component</el-button>
<h1 class="title">Action</h1>
  <div>
    <el-button type="text" @click="handleDownload">Download</el-button>
  </div>
