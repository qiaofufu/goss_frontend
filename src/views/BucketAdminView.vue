...
<template>
  <el-container>
    <el-header class="header">
        ...
        <div>
            <el-button type="danger" @click="handleDeleteBucket">Delete Bucket<template #icon><el-icon><DeleteFilled /></el-icon> </template></el-button>
          <el-button type="info">Refresh<template #icon><el-icon><RefreshRight /></el-icon></template></el-button>
        </div>
    </el-header>
